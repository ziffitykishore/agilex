...
class M20190506194919SetUnretrievableAttributes implements MigrationInterface
{
    ...
    {
        $this->resourceConfig->saveConfig('algoliasearch_extra_settings/extra_settings/categories_extra_settings', '{"attributesForFaceting": ["searchable(category_id)","searchable(parent_category_id)","searchable(parent_category_ids)"],"unretrievableAttributes":[]}', 'default', 0);
    }
}
