...
class M20181218143247CreateSampleCatalogPage1 implements MigrationInterface
{
    protected $page;
    protected $block;
    protected $email;
    ...
    public function execute(SetupInterface $setup)
    {
        ...
        // create CMS page "sample-catalog-page-1"
        $extraData = [
            'title' => 'Sample Catalog Page 1',
            'page_layout' => 'empty',
            'meta_title' => '',
            'meta_keywords' => '',
            'meta_description' => '',
        ...
        $this->page->create('sample-catalog-page-1', 'Sample Catalog Page 1', '{{widget type="Magento\\Cms\\Block\\Widget\\Block" template="widget/static_block/default.phtml" block_id="23"}}', $extraData);
