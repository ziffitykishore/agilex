...
class M20181116204054BaseConfigs implements MigrationInterface
{
    ...
    public function execute(SetupInterface $setup)
    {
        $this->setConfigs([
            ...
            'trans_email/ident_general/name' => 'traverstool',
            'trans_email/ident_general/email' => 'customerservice@traverstool.com',
            'trans_email/ident_sales/name' => 'traverstool',
            'trans_email/ident_sales/email' => 'customerservice@traverstool.com',
            'trans_email/ident_support/name' => 'traverstool',
            'trans_email/ident_support/email' => 'customerservice@traverstool.com',
            'trans_email/ident_custom1/name' => 'traverstool',
            'trans_email/ident_custom1/email' => 'customerservice@traverstool.com',
            'trans_email/ident_custom2/name' => 'traverstool',
            'trans_email/ident_custom2/email' => 'customerservice@traverstool.com',
