...
class M20170612210628AutoUpdatingCopyrightYear implements MigrationInterface
{
    protected $page;
    protected $block;
    protected $email;
    ...
    {
        // template looks for {{ YEAR }}
        $this->resourceConfig->saveConfig(
            'design/footer/copyright',
            'Copyright © {{ YEAR }} Something Digital. All rights reserved.',
            'default',
            0
        );
    }
