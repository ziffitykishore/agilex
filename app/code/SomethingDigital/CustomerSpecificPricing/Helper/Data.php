...
class Data
{
    ...
    */
    ...
    public function getTierPrice($customerSpecificPrices, $totalItemQty) {
        ...
        $tierPrice = null;
        if (isset($prices['QtyBreak1']) && $totalItemQty >= $prices['QtyBreak1']) {
            $tierPrice = $prices['QtyPrice1'];
        }
        if (isset($prices['QtyBreak2']) && $totalItemQty >= $prices['QtyBreak2']) {
            $tierPrice = $prices['QtyPrice2'];
        }
        if (isset($prices['QtyBreak3']) && $totalItemQty >= $prices['QtyBreak3']) {
