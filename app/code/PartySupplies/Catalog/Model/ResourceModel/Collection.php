...
namespace PartySupplies\Catalog\Model\ResourceModel;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    public function getSearchCriteriaBuilder()
    {
        if ($this->searchCriteriaBuilder === null) {
            $this->searchCriteriaBuilder = ObjectManager::getInstance()
                ->get(\WeltPixel\LayeredNavigation\Model\ResourceModel\Search\SearchCriteriaBuilder::class);
        }
     ...
     */
    public function setSearchCriteriaBuilder(
        \WeltPixel\LayeredNavigation\Model\ResourceModel\Search\SearchCriteriaBuilder $object
    ) {
