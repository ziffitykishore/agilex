...
use Ziffity\Blockcustomers\Api\Data\DataSearchResultsInterfaceFactory;
use Ziffity\Blockcustomers\Model\ResourceModel\Data as ResourceData;
use Ziffity\Blockcustomers\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Ziffity\Blockcustomers\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Ziffity\Blockcustomers\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Ziffity\Blockcustomers\Model\ResourceModel\Data\Collection $collection */
