...
use Ziffity\Zipcode\Api\Data\DataInterfaceFactory;
use Ziffity\Zipcode\Api\Data\DataSearchResultsInterfaceFactory;
use Ziffity\Zipcode\Model\ResourceModel\Data as ResourceData;
use Ziffity\Zipcode\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Ziffity\Zipcode\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Ziffity\Zipcode\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Ziffity\Zipcode\Model\ResourceModel\Data\Collection $collection */
