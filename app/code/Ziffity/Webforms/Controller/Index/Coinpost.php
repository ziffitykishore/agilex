...
use \Ziffity\Webforms\Model\CoinFactory;

 
class Coinpost extends \Magento\Framework\App\Action\Action
{
	...
	$data=array('customer_fn'=>$post['customer_fn'],'customer_ln'=>$post['customer_ln'],'customer_email'=>$post['customer_email'],'customer_phone'=>$post['customer_phone'],'customer_find'=>$post['customer_find']);
	$model->setData($data);
	$model->save();        
	//$this->_redirect('cms/index/index');
        ...
        try
        {
            ...
            ->setTemplateOptions(
                ...
                ->setTemplateVars([
                    'fname'  => $post['customer_fn'],
                    'lname' => $post['customer_ln'],
	            'email'  => $post['customer_email'],		
                    'phone'  => $post['customer_phone'],
		    'find'=> $post['customer_find']
                ])
                ->setFrom($sender)
