            ...
            onChangeDate: function (val){
                if (val) {
                    ...
                    if (shippingData !== null) {
                        localStorage.setItem(window.checkoutConfig.storeCode+"_selectedPickupDate", shippingData['pickupdate_date']);
                    } else {
                        localStorage.setItem(window.checkoutConfig.storeCode+"_selectedPickupDate", billingData['pickupdate_date']);
                    }
                }
