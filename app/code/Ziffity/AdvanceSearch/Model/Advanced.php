...
namespace Ziffity\AdvanceSearch\Model;
...
class Advanced extends \Magento\CatalogSearch\Model\Advanced
{
    ...
    public function addFilters($values)
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            /**
             * Ziffity customization starts
             */
            if($attribute->getAttributeCode() == 'price'){
		$value = $values[$attribute->getAttributeCode()];
            } elseif((isset($values['search_value']))) {
                if (trim($values['search_category'])) {
                    if ($attribute->getAttributeCode() == trim($values['search_category'])) {
                        $value = $values['search_value'];
                        $values[$attribute->getAttributeCode()] = $values['search_value'];
                    } else {
                        continue;
                    }
                } else {
                    if (($attribute->getAttributeCode() == "name") || ($attribute->getAttributeCode() == "description")) {
                        $value = $values['search_value'];
                        $values[$attribute->getAttributeCode()] = $values['search_value'];
                    } else {
                        continue;
    ...
    public function getProductCollection()
    {
        if ($this->_productCollection === null) {
            ...
            if(isset($_GET['category']) && is_numeric($_GET['category'])) {
                $collection->addCategoryFilter($this->getCategory(),true);
            }
    ...
    public function getCategory(){
        if(!$this->currentCategory){
            ...
            $this->currentCategory = $categoryModel->load($_GET['category']); 
        }
