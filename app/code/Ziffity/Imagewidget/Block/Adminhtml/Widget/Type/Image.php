...
namespace Ziffity\Imagewidget\Block\Adminhtml\Widget\Type;
...
class Image extends \Magento\Backend\Block\Template {
    ...
    \Magento\Backend\Block\Template\Context $context, \Magento\Framework\Data\Form\Element\Factory $elementFactory, $data = []
    ) {
    ...
    public function prepareElementHtml(AbstractElement $element) {
        ...
        $onInsertUrl = $this->getUrl('ziffity_widgettypes/wysiwyg_images/onInsert');
        $sourceUrl = $this->getUrl('cms/wysiwyg_images/index', ['target_element_id' => $element->getId(), 'on_insert_url' => $onInsertUrl]);
