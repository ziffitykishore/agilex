...
{
    const REDIRECT_DASHBOARD = 'customer/startup/redirect_dashboard';
    /**
    ...
    public function execute()
    {
        ...
        if ($this->session->isLoggedIn()) {
            ...
            try {
                ...
                $confirmation = $this->getRequest()->getParam(
                ...
                $confirmationStatus = $this->accountManagement->getConfirmationStatus(
                    $customer->getId()
                );
                if ($confirmationStatus === AccountManagementInterface::ACCOUNT_CONFIRMATION_REQUIRED) {
                    ...
                    if (!$this->scopeConfig->getValue(self::REDIRECT_DASHBOARD) && $requestedRedirect) {
                ...
                $response = [
                    ...
                    'message' => __(
                        ...
                        '<a href="javascript:void(0);" class="%1">click here</a>'
    ...
    protected function getSuccessMessage()
    {
        if ($this->addressHelper->isVatValidationEnabled()) {
            if ($this->addressHelper->getTaxCalculationAddressType() == Address::TYPE_SHIPPING) {
                $message = __(
                    'If you are a registered VAT customer, please <a href="%1">click here</a>'.
