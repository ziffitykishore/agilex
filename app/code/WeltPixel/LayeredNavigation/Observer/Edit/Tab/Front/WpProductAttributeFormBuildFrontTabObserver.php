...
class WpProductAttributeFormBuildFrontTabObserver implements ObserverInterface
{
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getDisplayOption() : AttributeOptions::DISPLAY_OPTION_DEF_VAL;
    }
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getVisibleOptions() : '';
    }
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getVisibleOptionsStep() : '';
    }
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getIsMultiselect() : '0';
    }
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getShowQuantity() : '0';
    }
    ...
    {
        return ($this->_wpAttributeObj) ? $this->_wpAttributeObj->getSortBy() : '1';
    }
