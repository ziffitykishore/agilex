...
namespace Vantiv\Payment\Block\Recurring\Customer\Subscriptions;
...
{
    /**
     * @var \Vantiv\Payment\Model\Recurring\Subscription|null
     */
    ...
    {
        /** @var \Vantiv\Payment\Pricing\Price\PlanPrice $planPrice */
    ...
    public function getSavedPayments()
    {
        ...
        foreach ($allPaymentMethods as $code => $method) {
            if (isset($method['can_use_for_vantiv_subscription']) && $method['can_use_for_vantiv_subscription']) {
