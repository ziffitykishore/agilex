...
use Vantiv\Payment\Model\Paypal\Config;
use Magento\Catalog\Block as CatalogBlock;
use Vantiv\Payment\Helper\Paypal\Shortcut\ValidatorInterface;
...
class Shortcut extends \Magento\Framework\View\Element\Template implements CatalogBlock\ShortcutInterface
{
    ...
    /**
     * @var \Vantiv\Payment\Model\Paypal\Express\Checkout\Factory
     */
     ...
     * @param \Vantiv\Payment\Model\Paypal\ConfigFactory $paypalConfigFactory
    ...
    public function __construct(
        ...
        \Vantiv\Payment\Model\Paypal\ConfigFactory $paypalConfigFactory,
    ...
    {
        $this->config->setMethod(Config::METHOD_CODE);
