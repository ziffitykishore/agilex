...
class EcheckTokenComponentProvider implements TokenUiComponentProviderInterface
{
    /**
    ...
    public function getComponentForToken(PaymentTokenInterface $token)
    {
        ...
        $component = $this->getComponentFactory()->create([
            ...
            'name' => 'Vantiv_Payment/js/view/payment/method-renderer/vantiv-echeck-vault'
        ]);
