...
class CcTokenComponentProvider implements TokenUiComponentProviderInterface
{
    /**
    ...
    public function getComponentForToken(PaymentTokenInterface $token)
    {
        ...
        if (isset($details['ccType']) && $details['ccType'] == 'AX') {
            $details['ccType'] = 'AE';
        }
        ...
        $component = $this->getComponentFactory()->create([
            ...
            'name' => 'Vantiv_Payment/js/view/payment/method-renderer/vantiv-cc-vault'
        ]);
