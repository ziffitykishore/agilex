...
/**
 * Gift Card RefundReversal request renderer.
 */
class GiftCardRefundReversalRenderer extends AbstractRenderer
{
    /**
     * Request wrapper.
     *
    ...
    /**
     * Build <refundReversal> XML node.
     *
     * <refundReversal reportGroup="REPORT_GROUP" customerId="CUSTOMER_ID">
     *     <litleTxnId>CREDIT_TRANSACTION_ID</orderId>
     * </refundReversal>
     *
     * @param array $subject
     * @return string
    ...
    public function render(array $subject)
    {
        ...
        $writer->startElement('refundReversal');
