...
/**
 * Gift Card LoadReversal request renderer.
 */
class GiftCardLoadReversalRenderer extends AbstractRenderer
{
    /**
     * Request wrapper.
     *
    ...
    /**
     * Build <loadReversal> XML node.
     *
     * <loadReversal reportGroup="REPORT_GROUP" customerId="CUSTOMER_ID">
     *     <litleTxnId>LOAD_TRANSACTION_ID</orderId>
     * </loadReversal>
     *
     * @param array $subject
     * @return string
    ...
    public function render(array $subject)
    {
        ...
        $writer->startElement('loadReversal');
