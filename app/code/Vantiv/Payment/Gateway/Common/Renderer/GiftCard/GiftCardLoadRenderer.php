...
/**
 * Gift Card Load request renderer.
 */
class GiftCardLoadRenderer extends AbstractRenderer
{
    /**
     * Request wrapper.
     *
     ...
     * Build <load> XML node.
     *
     * <load reportGroup="REPORT_GROUP" customerId="CUSTOMER_ID">
