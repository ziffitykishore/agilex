...
use Vantiv\Payment\Gateway\Recurring\Builder\UpdateDiscountSubscriptionBuilder;
use Vantiv\Payment\Gateway\Recurring\Parser\UpdateSubscriptionResponseParserFactory;

class UpdateDiscountSubscriptionCommand extends AbstractCustomCommand
{
    /**
     * @var UpdateDiscountSubscriptionBuilder
     */
    private $builder;
    /**
    ...
    /**
     * Executes command to update Subscription Discount
     *
     * @param array $subject
