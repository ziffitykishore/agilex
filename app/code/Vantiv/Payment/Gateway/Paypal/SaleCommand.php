...
use Vantiv\Payment\Gateway\Paypal\Builder\PaypalSaleBuilder as Builder;
...
class SaleCommand extends AbstractPaymentCommand
{
     ...
     * @param Reader $reader
     * @param PaypalSaleResponseParserFactory $parserFactory
     */
    public function __construct(
        HttpClient $client,
        Builder $builder,
        Reader $reader,
        PaypalSaleResponseParserFactory $parserFactory
    ) {
