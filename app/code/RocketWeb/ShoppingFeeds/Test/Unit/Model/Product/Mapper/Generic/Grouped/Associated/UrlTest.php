...
/**
 * Class UrlTest
 * @package RocketWeb\ShoppingFeeds\Test\Unit\Model\Product\Mapper\Generic\Grouped\Associated
 */
class UrlTest extends ModelFramework
{
    /**
     * @var \RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Grouped\Associated\Url
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Grouped\Associated\Url',
            []
        );
    }
