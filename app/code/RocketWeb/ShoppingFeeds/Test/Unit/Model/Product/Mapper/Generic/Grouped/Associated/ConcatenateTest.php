...
{
    /**
     * @var \RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Grouped\Associated\Concatenate
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Grouped\Associated\Concatenate',
            []
        );
    }
