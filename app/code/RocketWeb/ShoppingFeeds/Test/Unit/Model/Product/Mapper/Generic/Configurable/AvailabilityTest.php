...
{
    /**
     * @var \RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Configurable\Availability
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Configurable\Availability',
    ...
    public function testMapDefaultOutOfStock()
    {
        ...
        $params = [];
        $cell = $this->model->map($params);
        $this->assertEquals('out of stock', $cell);
    }
}