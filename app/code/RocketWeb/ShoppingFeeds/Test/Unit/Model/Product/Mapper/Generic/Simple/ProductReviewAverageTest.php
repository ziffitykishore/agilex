...
{
    /**
     * @var \RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Simple\ProductReviewAverage
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->summaryMock = $this->getModelMock(
            '\Magento\Review\Model\Review\Summary', ['getRatingSummary', 'load']);
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Simple\ProductReviewAverage',
            [
