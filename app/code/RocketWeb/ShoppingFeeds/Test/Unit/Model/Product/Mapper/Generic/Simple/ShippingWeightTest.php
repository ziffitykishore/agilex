...
{
    /**
     * @var \RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Simple\ShippingWeight
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = $this->objectManagerHelper->getObject(
            'RocketWeb\ShoppingFeeds\Model\Product\Mapper\Generic\Simple\ShippingWeight',
            []
        );
    }
