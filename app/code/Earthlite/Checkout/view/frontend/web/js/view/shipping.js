...
define([
    ...
    return Component.extend({
        ...
        displayTitle: ko.observable(addressList().length > 0 ? false : true),
        ...
        getPopUp: function () {
            ...
            if (!popUp) {
                ...
                this.popUpForm.options.title = 'New Address';
        ...
        onClosePopUp: function () {
            ...
            $('.not-selected-item').css("display","none");
        },
        ...
        /**
         * check address length to display title
         */
