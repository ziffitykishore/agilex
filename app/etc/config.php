...
return [
    'modules' => [
        ...
        'Wyomind_AdvancedInventory' => 1,
        'Ziffity_AdvancedInventory' => 1,
        'Ziffity_AjaxLogin' => 1,
        'Ziffity_Avalara' => 1,
        'Ziffity_Banners' => 1,
        'Ziffity_Bundle' => 1,
        'Ziffity_CanonicalUrl' => 1,
        'Ziffity_Pickupdate' => 1,
        'Ziffity_Checkout' => 1,
        'Ziffity_Common' => 1,
        'Ziffity_Customer' => 1,
        'Ziffity_Deliverydate' => 1,
        'Ziffity_DuplicateImagePatch' => 1,
        'Ziffity_Lazyloader' => 1,
        'Ziffity_PickupCheckout' => 1,
        'Ziffity_Cart' => 1,
        'Ziffity_PickupdateOR' => 1,
        'Ziffity_Zipcode' => 1
    ]
];
