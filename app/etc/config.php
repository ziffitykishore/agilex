...
return [
    ...
    'modules' => [
        ...
        'Earthlite_Checkout' => 1,
        'Earthlite_CustomSort' => 1,
        'Earthlite_Customer' => 1,
        'Earthlite_DownloadableSpecification' => 1,
        ...
        'Magedelight_Base' => 1,
        'Earthlite_NewTrending' => 1,
        'Earthlite_OrderComments' => 1,
        'Earthlite_OrderSuccess' => 1,
        'Earthlite_LayerNavigation' => 1,
        ...
        'Earthlite_MegaMenu' => 1,
        'Earthlite_InfiniteScroll' => 1,
        'Earthlite_PartFinder' => 1,
        'Earthlite_Blog' => 1,
        'ShipperHQ_Common' => 1,
        'ShipperHQ_Logger' => 1,
        'ShipperHQ_Shipper' => 1,
