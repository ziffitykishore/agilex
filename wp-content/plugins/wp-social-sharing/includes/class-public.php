...
class SS_Public {
	...
	public function social_sharing( $atts=array() ) {
		extract(shortcode_atts(array(
				'social_options' => 'twitter, facebook, googleplus, pinterest, linkedin, twitter',
				'twitter_username' => '',
		...
		$ssbutton_facebook		=	'button-facebook fa fa-facebook';
		$ssbutton_twitter		=	'button-twitter fa fa-twitter';
		$ssbutton_googleplus	=	'button-googleplus fa fa-google-plus';
		$ssbutton_linkedin		=	'button-linkedin fa fa-linkedin';
		$ssbutton_pinterest		=	'button-pinterest fa fa-pinterest';
		$ssbutton_xing			=	'button-xing fa fa-xing';
		$ssbutton_reddit		=	'button-reddit fa fa-reddit';
		$sssocial_sharing='';
		if($show_icons){
