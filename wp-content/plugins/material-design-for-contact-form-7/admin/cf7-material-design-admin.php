...
class CF7_Material_Design_Admin
{
    ...
    {
        set_transient( 'cf7md_pro_ad_closed', array( 1 ), 5 * MINUTE_IN_SECONDS );
        echo  'Success' ;
        wp_die();
    }
    ...
    {
        set_transient( 'cf7md_customize_link_closed', array( 1 ), 5 * MINUTE_IN_SECONDS );
    ...
    private function get_help_tab_html()
    {
        ...
        ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <code>terms</code> - the terms to which the user must agree<hr />
                            <?php 
        echo  $label_attr ;
        ?><hr />
                            <?php 
