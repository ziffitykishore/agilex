...
(function ($) {
  ...
  $(".executive-wrap  .slider-nav").slick({
    ...
    arrows: true,
    prevArrow:
      '<a href="#" class="slick-prev btn btn-ripple ripple-link" aria-label="Previous">Previous</a>',
    nextArrow:
      '<a href="#" class="slick-next btn btn-ripple ripple-link" aria-label="Next">Next</a>',
    focusOnSelect: true,
    responsive: [
      {
        breakpoint: 768,
  ...
  $("#affiliate-slider").slick({
    ...
    nextArrow:
      '<button class="slick-next btn btn-ripple ripple-link" aria-label="Next" type="button">Next</button>',
    dots: false,
    responsive: [
      {
        breakpoint: 1024,
  ...
  $(window).load(function () {
    ...
    jQuery(
      ...
      $("#hsForm_d9bc8fe4-271f-4085-bb25-339c86aa3b8").trigger("reset");
