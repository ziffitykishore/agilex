<?php
/**
 * Template Name: Single What makes agiles unique
 *
 * @package Agilex
 * @since Agilex 1.0
 */
...
if($tabdetails) { ?>
  <div class="tab-section sub-category wow fadeIn">
    <div class="container">
      ...
      <li class="<?php echo ($i == 1) ? "active": '';?>"><a role="tab" class="text-uppercase btn-ripple" href="#tab-<?php echo $i; ?>" data-toggle="tab"><?php echo $tabdetail["tab-sec-title"]; ?></a></li>
      <?php $i++; } ?> 
      </ul>
        ...
        <div id="tab-<?php echo $i; ?>" class="tab-pane fade <?php echo ($i == 1) ? "active": '';?> in">
          ...
          <div class="tab-inner flex-sec effect-milo border-efx">
            ...
            <div class="border-ani"></div>
              ...
              <img data-src="<?php echo wp_get_attachment_url($tabdetail["tab-sec-image"]); ?>" class="lazy" alt="<?php echo $tabdetail["tab-sec-title"]; ?>"/>
              <?php } else {?>
                <img data-src="<?php bloginfo('template_directory'); ?>/images/placeholder_585X500.png" class="lazy" alt=""/>
              <?php }?>
              </div>
            </div>
            <div class="content-wrap flex-sm-100 flex-50 <?php if(empty($tabdetail["tab-sec-image"])) {  echo "flex-100";  } else { echo "flex-50" ;}  ?>">
              <h2 class="feature-title"><?php echo $tabdetail["tab-sec-title"]; ?></h2>
