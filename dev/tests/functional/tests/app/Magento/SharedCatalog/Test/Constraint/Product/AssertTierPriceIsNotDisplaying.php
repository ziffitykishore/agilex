...
/**
 * Assert tier price is not displaying in product advanced pricing popup.
 */
class AssertTierPriceIsNotDisplaying extends AbstractConstraint
{
    /**
    ...
    {
        return 'Tier price option is not present in advanced price options.';
    }
}
