...
namespace Magento\SharedCatalog\Test\Block\Adminhtml\Promo\Quote\Edit\Section;
...
class RuleInformation extends Section
{
    ...
    /**
     * Check whether shared catalog group is visible.
     *
     * @param SharedCatalog $sharedCatalog
     * @return bool
     */
    public function isVisibleSharedCatalogGroup(SharedCatalog $sharedCatalog)
    {
        $options = $this->_rootElement->find($this->customerGroup)->getText();
        return false !== strpos($options, $sharedCatalog->getName());
    }
}
